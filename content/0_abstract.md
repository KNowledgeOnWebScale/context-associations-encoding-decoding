...
However, this association method
...
Not all metadata is always explicitly described at the data level.
<!-- need -->
...
<!-- evaluation -->
We evaluate Context Associations by demonstrating that---for each of the aforementioned annotation systems---metadata can be uniformly associated with target statements and queried across applications.
...
<!-- conclusion -->
By providing a uniform representation of metadata associated with target RDF statements,
